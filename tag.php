...
<main class="container" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
    <div class="row">
        <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <article>
                <h2>
                    <?php _e('Disculpe, su busqueda no arrojo ningun resultado', 'vitahealth'); ?>
                </h2>
                <h3>
                    <?php _e('Dirígete nuevamente al', 'vitahealth'); ?>
                    <a href="<?php echo home_url('/'); ?>" title="<?php _e('Volver al Inicio', 'vitahealth'); ?>">
                        <?php _e('inicio', 'vitahealth'); ?>
                    </a>.</h3>
            </article>
            <?php endif; ?>
        </section>
