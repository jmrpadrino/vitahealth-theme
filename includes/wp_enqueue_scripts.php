...
function vitahealth_load_js() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN FUNCTIONS -*/
        wp_register_script('fullpage-js', get_template_directory_uri() . '/js/jquery.fullpage.min.js', array('jquery'), $version_remove, true);
        wp_enqueue_script('fullpage-js');
        
        /*- MAIN FUNCTIONS -*/
        wp_register_script('scrolloverflow-js', get_template_directory_uri() . '/js/scrolloverflow.min.js', array('jquery'), $version_remove, true);
        wp_enqueue_script('scrolloverflow-js');

        /*- MAIN FUNCTIONS -*/
        wp_register_script('fullpage-ext-js', get_template_directory_uri() . '/js/jquery.fullpage.extensions.min.js', array('jquery', 'fullpage-js'), $version_remove, true);
...
add_action('init', 'vitahealth_load_js');
