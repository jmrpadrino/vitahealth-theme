        ...
        <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <article id="post-404">
                ...
                <div class="col-lg-5 col-lg-offset-3 col-md-5 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2">
                    <h1 class="text-center"><?php _e('Error 404', 'vitahealth'); ?></h1>
                    <hr>
                    <h4 class="text-center"><?php _e('No podemos encontrar la página que buscas. Dirígete nuevamente al', 'vitahealth'); ?> <a href="<?php echo home_url('/'); ?>" title="<?php _e('Volver al Inicio', 'vitahealth'); ?>"><?php _e('inicio', 'vitahealth'); ?></a>.</h4>
                </div>
                <div class="clearfix"></div>
            </article>
        </section>
